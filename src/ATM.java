...
//    private final static String ERROR_SUM = "Ошибка. Сумма введена некорректно.";
...
//            } else System.out.println(ERROR_SUM);
//        } else System.out.println(ERROR_SUM);
    }
...
//        } else System.out.println(ERROR_SUM);
    ...
    public static void viewBalance() {
        System.out.printf("В банкомате осталось денежных средств на сумму: %d руб.\n", getSum());
        viewAmountNotes();
    }
